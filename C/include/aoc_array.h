...
#define aoc_int32_array_new()               (aoc_array_new(AOC_INT32, 0))
...
#define aoc_int32_array_append(_arr_, _val_)                                                       \
    (ISNULL(_arr_) ? NULL : (ISTYPE(_arr_, AOC_INT32) ? (aoc_array_append(_arr_, &(_val_))) : NULL))
#define aoc_int32_array_prepend(_arr_, _val_)                                                      \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_INT32) ? (aoc_array_prepend(_arr_, &(_val_))) : NULL))
...
#define aoc_uint32_array_new()                   (aoc_array_new(AOC_UINT32, 0))
...
#define aoc_uint32_array_append(_arr_, _val_)                                                      \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_UINT32) ? (aoc_array_append(_arr_, &(_val_))) : NULL))
#define aoc_uint32_array_prepend(_arr_, _val_)                                                     \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_UINT32) ? (aoc_array_prepend(_arr_, &(_val_))) : NULL))

// int64_t array function macros
#define aoc_int64_array_new()               (aoc_array_new(AOC_INT64, 0))
...
#define aoc_int64_array_sort(_arr, func)    (aoc_array_sort(_arr, func))
#define aoc_int64_array_append(_arr_, _val_)                                                       \
    (ISNULL(_arr_) ? NULL : (ISTYPE(_arr_, AOC_INT64) ? (aoc_array_append(_arr_, &(_val_))) : NULL))
#define aoc_int64_array_prepend(_arr_, _val_)                                                      \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_INT64) ? (aoc_array_prepend(_arr_, &(_val_))) : NULL))

// uint64_t array function macros
#define aoc_uint64_array_new()               (aoc_array_new(AOC_UINT64, 0))
...
#define aoc_uint64_array_sort(_arr, func)    (aoc_array_sort(_arr, func))
#define aoc_uint64_array_append(_arr_, _val_)                                                      \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_UINT64) ? (aoc_array_append(_arr_, &(_val_))) : NULL))
#define aoc_uint64_array_prepend(_arr_, _val_)                                                     \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_UINT64) ? (aoc_array_prepend(_arr_, &(_val_))) : NULL))

// String (char *) array function macros
#define aoc_str_array_new()                (aoc_array_new(AOC_STR, 0))
...
#define aoc_char_array_new()               (aoc_array_new(AOC_CHAR, 0))
...
#define aoc_char_array_append(_arr_, _val_)                                                        \
    (ISNULL(_arr_) ? NULL : (ISTYPE(_arr_, AOC_CHAR) ? (aoc_array_append(_arr_, &(_val_))) : NULL))
#define aoc_char_array_prepend(_arr_, _val_)                                                       \
    (ISNULL(_arr_) ? NULL : (ISTYPE(_arr_, AOC_CHAR) ? (aoc_array_prepend(_arr_, &(_val_))) : NULL))
...
#define aoc_uchar_array_new()                   (aoc_array_new(AOC_UCHAR, 0))
...
#define aoc_uchar_array_append(_arr_, _val_)                                                       \
    (ISNULL(_arr_) ? NULL : (ISTYPE(_arr_, AOC_UCHAR) ? (aoc_array_append(_arr_, &(_val_))) : NULL))
#define aoc_uchar_array_prepend(_arr_, _val_)                                                      \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_UCHAR) ? (aoc_array_prepend(_arr_, &(_val_))) : NULL))

// Point array function macros
#define aoc_point_array_new(size_)          (aoc_array_new(AOC_POINT, 0))
...
#define aoc_point_array_append(_arr_, _val_)                                                       \
    (ISNULL(_arr_) ? NULL : (ISTYPE(_arr_, AOC_POINT) ? (aoc_array_append(_arr_, &(_val_))) : NULL))
#define aoc_point_array_prepend(_arr_, _val_)                                                      \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_POINT) ? (aoc_array_prepend(_arr_, &(_val_))) : NULL))

// Line (struct Line) array function macros
#define aoc_line_array_new()               (aoc_array_new(AOC_LINE, 0))
...
#define aoc_line_array_append(_arr_, _val_)                                                        \
    (ISNULL(_arr_) ? NULL : (ISTYPE(_arr_, AOC_LINE) ? (aoc_array_append(_arr_, &(_val_))) : NULL))
#define aoc_line_array_prepend(_arr_, _val_)                                                       \
    (ISNULL(_arr_) ? NULL : (ISTYPE(_arr_, AOC_LINE) ? (aoc_array_prepend(_arr_, &(_val_))) : NULL))
...
// Point array function macros
#define aoc_ptr_array_new()                  (aoc_array_new(AOC_PTR, 0))
...
#define aoc_double_array_new()               (aoc_array_new(AOC_DOUBLE, 0))
...
#define aoc_double_array_sort(_arr, func)    (aoc_array_sort(_arr, func))
#define aoc_double_array_append(_arr_, _val_)                                                      \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_DOUBLE) ? (aoc_array_append(_arr_, &(_val_))) : NULL))
#define aoc_double_array_prepend(_arr_, _val_)                                                     \
    (ISNULL(_arr_) ? NULL                                                                          \
                   : (ISTYPE(_arr_, AOC_DOUBLE) ? (aoc_array_prepend(_arr_, &(_val_))) : NULL))
