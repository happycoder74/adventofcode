...
void        timer_func_int(int, int(func)(AocData_t *), AocData_t *, int);
...
void       *timer_return(void *(func)(void *), void *, const char *);
void        timer_void(void(func)(void *), void *, const char *);
