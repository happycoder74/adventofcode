...
#define calloc(n_elem_, size_)                                                                     \
    aoc_calloc_internal(n_elem_, size_, __FUNCTION__, __FILENAME__, __LINE__)
#define realloc(ptr_, size_) aoc_realloc_internal(ptr_, size_, __FUNCTION__, __FILENAME__, __LINE__)
#define free(ptr_)           aoc_free_internal(ptr_, __FUNCTION__, __FILENAME__, __LINE__)
...
void *aoc_realloc_internal(void *mem_ptr, size_t new_size, const char *function, const char *file,
                           const int line);
void  aoc_free_internal(void *mem_ptr, const char *function, const char *file, const int line);
#else
#define malloc(size_)          aoc_malloc_internal(size_)
#define calloc(n_elem_, size_) aoc_calloc_internal(n_elem_, size_)
#define realloc(ptr_, size_)   aoc_realloc_internal(ptr_, size_)
#define free(ptr_)             aoc_free_internal(ptr_)
